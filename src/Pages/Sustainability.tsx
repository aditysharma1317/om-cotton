                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                ...
                                <li><a href="#" className="text-[#D88F70] transition-colors duration-400 cursor-pointer">Sustainability</a></li>
                                <li><a href="https://readdy.ai/home/f9f42b02-5c36-49ef-ac63-f199f73582d2/ae45447f-9172-433e-b03a-ff4e7f415fae" data-readdy="true" className="text-gray-600 hover:text-[#D88F70] transition-colors duration-400 cursor-pointer">About Us</a></li>
                                <li><a href="#" className="text-gray-600 hover:text-[#D88F70] transition-colors duration-400 cursor-pointer">Contact</a></li>
                            </ul>
                        </div>
                        <div>
                            <h3 className="text-lg font-semibold mb-6 tracking-wide">Sustainability</h3>
                            <ul className="space-y-3">
                                <li><a href="#" className="text-gray-600 hover:text-[#D88F70] transition-colors duration-400 cursor-pointer">Our Initiatives</a></li>
                                <li><a href="#" className="text-gray-600 hover:text-[#D88F70] transition-colors duration-400 cursor-pointer">Certifications</a></li>
                                <li><a href="#" className="text-gray-600 hover:text-[#D88F70] transition-colors duration-400 cursor-pointer">Sustainable Products</a></li>
                                <li><a href="#" className="text-gray-600 hover:text-[#D88F70] transition-colors duration-400 cursor-pointer">Manufacturing Process</a></li>
                                <li><a href="#" className="text-gray-600 hover:text-[#D88F70] transition-colors duration-400 cursor-pointer">Future Goals</a></li>
                            </ul>
                        </div>
                        <div>
